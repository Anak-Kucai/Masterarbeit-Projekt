...
Biochar is defined as a carbon-rich pyrogenous, solid product produced from biomass-derived digestate or from biomass itself, which is organic matter, mainly plant or animal waste. Biochar is produced through pyrolysis, a thermochemical process carried out at elevated temperature in the absence of oxygen. Unlike charcoal, it is not only used as a renewable fuel but also predominantly serves to improve soil fertility, maintain carbon neutrality, and mitigate particular environmental pollution. \cite{Qi2024}    
...
\newpage
\subsection{The Brunauer-Emmett-Teller (BET) analysis}
...
The Equation to calculate the specific surface area of the biochar: 
