...
%Carbon dioxide activation represents the other primary gaseous method for the physical activation of biochar and shares several mechanistic similarities with steam activation, while also exhibiting important and consequential differences in the pore structures and surface chemistries it produces (Dalai and Azargohar, 2007). Like steam, CO₂ can be applied either during the pyrolysis of the original biomass feedstock or as a separate activation step applied to already-synthesized biochar, offering flexibility in process design (Lee et al., 2017). Elemental analysis has shown that biochars pyrolyzed under a CO₂ atmosphere contain higher proportions of oxygen and nitrogen compared to those pyrolyzed under nitrogen, while nitrogen-pyrolyzed biochars retain more carbon, hydrogen, and sulfur (Tian et al., 2017). The lower hydrogen-to-carbon ratio of CO₂-pyrolyzed biochar indicates a higher degree of carbonization and more highly condensed aromatic structures, while the higher oxygen-to-carbon ratio suggests greater hydrophilicity relative to nitrogen-pyrolyzed material (Lee et al., 2017). CO₂-assisted pyrolysis has also been shown to promote the enrichment of alkali metals including sodium, potassium, and calcium within the biochar, particularly at higher pyrolysis temperatures, providing a potential avenue for controlling biochar properties relevant to soil amendment and adsorption applications (Tian et al., 2017). The fundamental mechanism of CO₂ activation is governed by the Boudouard reaction, in which carbon dioxide undergoes dissociative chemisorption onto the carbon surface, producing a surface oxide complex and carbon monoxide (Jung and Kim, 2014). The surface oxide subsequently desorbs from the carbon surface, further developing the pore structure of the material. Carbon monoxide produced as a gaseous product can also be re-adsorbed onto active carbon sites, retarding the forward gasification reaction. Thermodynamically, the Boudouard reaction is strongly endothermic, with a large positive enthalpy of approximately 172 kJ/mol at 298 K, meaning that the equilibrium does not favor carbon monoxide production until temperatures exceed approximately 700°C (Jung and Kim, 2014). This thermodynamic constraint means that meaningful CO₂ activation requires elevated temperatures, with the rate of the reaction and the associated carbon burn-off increasing substantially as temperature rises. Similar to steam activation, an increase in CO₂ flow causes a higher concentration gradient, compelling the oxidant to enter pores at a faster rate through bulk diffusion and thereby enhancing the gasification yield (Sajjadi et al., 2018).


%In terms of pore structure development, CO₂ activation behaves in a markedly different manner from steam activation. While steam generates both micropores and mesopores, producing a broad pore size distribution, CO₂ activation predominantly develops micropores (Dalai and Azargohar, 2007; Feng et al., 2018). This fundamental difference arises from the distinct molecular properties and reaction mechanisms of the two activating agents. The larger molecular size of CO₂ relative to water restricts its diffusion into the narrowest pore channels, concentrating gasification activity in regions accessible to the larger molecule and resulting in the preferential creation and widening of micropores. Although a wide pore size distribution is generally advantageous because mesopores and macropores serve as transport pathways that facilitate access of target molecules to internal adsorption sites, the high concentration of micropores generated by CO₂ activation confers specific advantages for the adsorption of smaller molecules, for which micropore surface area is the dominant determinant of capacity (Valderrama et al., 2008). The simultaneous creation of new microporous structures and the burning off of carbonaceous material within existing pores are both characteristic features of CO₂-activated biochars (Kołtowski et al., 2017b).


%The effects of activation temperature and duration on CO₂-activated biochar follow broadly similar trends to those observed in steam activation, though with important distinctions. Increasing activation temperature from 700 to 900°C has been consistently associated with progressive increases in Brunauer-Emmett-Teller surface area and micropore volume across a range of feedstock types (Jung and Kim, 2014; Guo et al., 2009). Jung and Kim (2014) demonstrated that CO₂ activation at 800°C applied under three different procedural conditions, including pyrolysis under nitrogen followed by CO₂ activation without cooling, the same procedure with an intermediate cooling step, and both pyrolysis and activation under CO₂, all significantly increased surface area from 249 to approximately 720 m²/g and total porosity from 0.11 to approximately 0.33 cm³/g. A further temperature increase to 900°C for 60 minutes without intermediate cooling remarkably elevated these values to 1126 m²/g and 0.49 cm³/g respectively, illustrating the strong temperature dependence of the CO₂ activation process. Enhancing activation temperature to 900°C was similarly found to be favorable to the development of Brunauer-Emmett-Teller surface area and micropore volume in coconut shell-derived biochar, while further temperature increases promoted widening of micropores and increases in mesopore volume (Guo et al., 2009). Very long activation times exceeding four hours or very high CO₂ flow rates exceeding 400 cm³/min have been found to lead to collapse of the pore skeleton, reducing surface area and micropore volume (Guo et al., 2009). The nature of the biochar feedstock exerts a significant influence on the effectiveness of CO₂ activation. Biochars with higher carbon content and lower hydrogen-to-carbon ratios respond more favorably to CO₂ activation, developing larger surface areas and more extensive micropore networks (Zhang et al., 2004). Zhang et al. (2004) performed CO₂ activation on biochars produced from three different agricultural and forest residues and found that biochars derived from oak chips and corn hulls, with carbon contents of approximately 70%, yielded the highest Brunauer-Emmett-Teller surface areas ranging from 640 to over 1000 m²/g, while corn stover biochar with a lower carbon content of approximately 59% achieved lower surface area values of 400 to 700 m²/g under the same conditions. CO₂ activation has been found to be largely ineffective for biochars derived from feedstocks with very low carbon contents, such as sewage sludge biochar containing approximately 31% carbon, in which the limited carbonizable material restricts the degree of porosity development achievable (Ros et al., 2006). Longer activation times at higher temperatures have also been shown to produce better results for biochars with lower hydrogen-to-carbon ratios, further confirming the importance of feedstock selection in CO₂ activation (Veksha et al., 2016). Gasification agents including both steam and CO₂ have also been shown to affect the aromatic ring structures of biochar during activation. During the activation process, intermediate atoms generated from the steam-char or CO₂-char reactions penetrate into the char matrix and contribute to the transformation of small aromatic ring systems into larger ring systems (Song et al., 2015). Consequently, some small aromatic rings are removed or consumed while some larger rings grow further. Song et al. (2015) demonstrated that the gasification agent exerted a larger effect on the reforming of large aromatic ring systems compared to smaller and isolated aromatics, while Feng et al. (2018) showed that steam had a larger overall effect than CO₂ on the reforming of both single and multiple aromatic ring structures. From a surface chemistry standpoint, CO₂ activation differs from steam activation in the types of functional group transformations it induces. Whereas steam activation tends to increase carboxylic and phenolic group concentrations on the biochar surface (Kołtowski et al., 2017a), CO₂ activation has been associated with the elimination of hydroxyl groups and carbonyl groups through high-temperature thermal decomposition (Jung and Kim, 2014). The oxygen present in CO₂ does promote the formation of oxygen-containing functional groups on the biochar surface, but the extent of this surface oxidation is generally less pronounced than that achieved by steam activation (Feng et al., 2016). As a result, steam-activated biochars typically contain more acidic surface centers than their CO₂-activated counterparts, a difference with direct implications for adsorption behavior. These acidic centers are capable of combining with polyaromatic rings bearing negatively charged electrons, activating thermal cracking reactions and providing specific adsorption advantages for polar and aromatic compounds (Feng et al., 2016). This mechanistic difference is reflected in comparative adsorption performance data, with steam-activated biochars generally demonstrating superior capacity for organic compound adsorption compared to CO₂-activated samples produced under equivalent conditions, particularly for biochars produced under higher pyrolysis temperatures (Toles et al., 2000). Despite these differences in surface chemistry, CO₂ activation has demonstrated particular advantages for certain adsorption applications. Kołtowski et al. (2017b) compared activation of biochar using CO₂, steam, and microwave irradiation and concluded that, although steam activation resulted in higher total surface areas, the most effective adsorbents for reducing the concentration of 16 freely dissolved polyaromatic hydrocarbons in industrially contaminated soils were those activated under CO₂. This superiority was attributed to the higher concentration of micropores comprising approximately 74% of total surface area and the larger micropore volume relative to total pore volume of approximately 61% in the CO₂-activated samples, demonstrating that total surface area alone is not always the most reliable predictor of adsorption performance and that pore size distribution and micropore characteristics must also be considered (Kołtowski et al., 2017b). From a cost and energy perspective, CO₂ activation is generally considered less economical than steam activation. Toles et al. (2000) estimated the costs of carbon dioxide-activated and steam-activated almond shell carbons for a manufacturing facility processing 14,000 kg of shells per day with a carbon yield of 16% for both processes. Their analysis indicated electricity consumption of 7501 KWH/day for CO₂ activation compared to 4075 KWH/day for steam activation, reflecting both the higher thermodynamic energy requirements of the endothermic Boudouard reaction and the significant cost differential between water and carbon dioxide gas as raw materials. 

%Taken together, steam and CO₂ activation represent complementary physical modification strategies whose relative merits depend critically on the intended application of the activated biochar (Sajjadi et al., 2018). Steam activation is generally preferred where broad pore size distributions, high surface areas, and abundant surface functional groups are required, particularly for the adsorption of large organic molecules, heavy metals, and pharmaceutical compounds. CO₂ activation offers advantages where highly microporous structures are desired for the removal of smaller molecular species, and where precise control over micropore development is a priority. An informed selection between the two methods, guided by the physicochemical characteristics of the biochar feedstock and the target application, is essential for maximizing the performance of the activated material (Dalai and Azargohar, 2007; Rajapaksha et al., 2016).

\subsubsection{Sulfur Loading of Biochar}

Sulfur loading refers to a process for increasing the sulfur content in biochar by exposing it to sulfur compounds, primarily hydrogen sulfide. This process is used exclusively with activated biochar, as it has a larger specific surface area compared to conventional biochar. 




In this method, a gaseous sulfur compound is passed through activated biochar together with air, where sulfur is adsorbed on the surface of biochar. 

\[
\mathrm{H_2S + \frac{1}{2}O_2 \rightarrow S + H_2O}
\]
