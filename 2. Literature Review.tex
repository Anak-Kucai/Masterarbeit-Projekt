...
Steam activation is the most frequently used method, together with carbon dioxide activation, for the activation of biochar. In this process, biochar is commonly exposed to steam at temperatures around 800-900°C for 30 minutes to 3 hours. The overall reaction of steam activation is as follows: 


\begin{equation}
C + \frac{1}{2}O_2 \rightarrow S + H_2O
\end{equation}
...
The biochar activation with carbon dioxide 
...
involves the Boudouard reaction (C + $CO_2$ $\leftrightarrow$ 2CO). In this
process, $CO_2$ undergoes dissociative chemisorption on the
