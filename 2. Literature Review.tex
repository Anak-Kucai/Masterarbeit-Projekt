...
Biomass can be classified, based on its composition, into lignocellulosic and non-lignocellulosic biomass. Lignocellulosic biomass primarily consists of biomass from crop residues, which mainly comprises 35–51\% cellulose, 20–33\% hemicellulose, and 13–30\% lignin, although these percentages vary depending on the type of lignocellulosic biomass \cite{Segers2024}. In contrast, non-lignocellulosic biomass, which typically comes from animal waste, consists mainly of lipids, proteins, and mineral components, with only a small fraction of cellulose, hemicellulose, and lignin. \cite{Segers2024}.

\subsection{Biochar}

Biochar is as a carbon-rich pyrogenous, solid product produced from biomass-derived digestate or from biomass itself. Biochar is produced through a thermochemical process called pyrolysis that is carried out at elevated temperature in the absence of oxygen. Biochar has broader application areas compared to coal. It can used both as a renewable fuel and key solution to improve soil fertility, maintain carbon neutrality, and mitigate particular environmental pollution \cite{Qi2024}. 
...
\begin{table}[H]
\centering
\caption{Specific surface area of different biochars. PT = pyrolysis temperature. Pristine = biochar obtained directly after pyrolysis without subsequent modification.}
...
Physical activation refers to a process that modifies the properties of biochar through activation. The activated biochar has a larger surface area, wide range of functional groups and a more uniform pore size distribution, leading to improvement on adsorption capacity of biochar. The most established and practically used physical approach is to activate the biochar by treating it with partial oxidizing agent, mainly steam and carbon dioxide, at temperature above 700°C. During this gaseous activation, oxidizing agents penetrate and gasify the structure of biochar consisting mainly from carbon atom, resulting in newly open and wider blocked pores. Therefore, activated biochar has higher internal surface areas and more oxygen functional groups as adsorption active sites \cite{Sajjadi2019}. 
...
The main reaction of steam activation begins with the interaction of water molecule and carbon surface. Through the interaction, oxygen is transffered from water molecule to carbon surface to form a surface oxide (R\ref{reaction 1}), which further may be devolved as CO (R\ref{reaction 2}) \cite{Sajjadi2019}.
...
The overall reaction of steam activation is described as follows (R\ref{reaction 3}): 
...
However, CO desorbed from the surface may scavenge the surface oxide to produce CO$_2$, in which a new free active carbon site on the surface can subsequently be regenerated to enable further reaction (R\ref{reaction 4}) \cite{Sajjadi2019}. 

\begin{equation}
CO_(g_) + C(O) \rightarrow CO_2 + C_f
\label{reaction 4}
\end{equation}

The scavenging of surface oxide by the gaseous CO is also followed by water-gas shift reaction in which steam is reacted with CO to produce CO$_2$ (R\ref{reaction 5}) and H$_2$ (R\ref{reaction 6}), which may result in another carbon gasification that further activates the surface \cite{Sajjadi2019}. 
...
During steam activation, The water-gas shift reaction and gradual removal of carbon contribute the most to the pore development of biochar. Through steam activation, the residual pyrolysis by-products such as acids, aldehydes, and ketones trapped in the biochar structure are removed, resulting to the improvement of the porous structure of the respective biochar. For this reason, steam activation results in a more widely pore size distribution than CO$_2$ activation, as it favors the formation of both micropores and mesopores, whereas CO$_2$ activation primarily promotes the development of micropores. Moreover, steam activation increases the phenolic and carboxylic groups, resulting in biochar with higher hydrophilicity \cite{Sajjadi2019}.  
...
The outcome of steam activation highly depends on the activation temperature and time, as well as the mass ratio of steam to carbon (S/C). The pore volume/radius and SSA tend to improve greatly at higher activation temperature and time. The steam activation at higher temperature can broadly offset the negative effect of low-temperature pyrolysis on biochar porosity and its surface area. The reactivity of activated biochar also increases at activation temperatures of up to 700 °C, with 800 °C being the highest temperature at which the greatest reactivity is observed, as the concentration of AAEM species on the biochar surface is at the highest level \cite{Sajjadi2019}. However, the reactivity decreases at temperatures above 800-850°C, as AAEM species are gradually consumed, while carbon conversion increases. Furthermore, three oxygen-containing surface functional groups—such as carboxyl, phenol, and lactone groups—can be partially degraded during high-temperature steam activation, with new functional groups forming only to a limited extent. This suggests that the amount of oxygen-containing functional groups increases at lower temperatures for longer activation time \cite{Sajjadi2019}. 

\vspace{0.6em}

Although higher steam activation temperature indicates that the physicochemical properties tend to improve, a longer steam activation time longer than 45-50 minutes (depending on the origin of the biochar) tends to have negative effects on the corresponding properties. Steam activation at a higher temperature, over a longer period of time, and greater water supply can lead to faster and more intense gasification, in which micropores are turned into mesopores and macropores due to pore sizes larger than those desired for adsorption. In general, steam-activated biochar exhibits a higher adsorption capacity, particularly with regard to the adsorption of heavy metals such as copper (Cu), nickel (Ni), and cadmium (Cd), as well as pharmaceuticals and pesticides, because its physicochemical properties—including surface area, micropore volume, and oxygen-containing functional groups—are improved \cite{Sajjadi2019}. 
...
This process is favored for activated biochar due to its larger SSA and modifiable porosity compared to pristine biochar \cite{Lin2025H2SOxidationPETBiochar}. The sulfur loading process determines the adsorption capacity of biochar, which is expressed in milligrams of sulfur-containing material per gram of biochar.
...
%The following sections therefore focus on these three. Pyrolysis temperature was treated as the principal variable in this work (400, 500, and 600~°C), while heating rate and residence time were held constant so that the temperature effect could be isolated. The remaining factors were fixed by the experimental setup: a single type of digestate was used throughout, all runs were carried out in the same fixed-bed furnace under an inert atmosphere at ambient pressure, and the feedstock was prepared to a comparable particle size. These factors are summarized below for completeness and are not part of the parametric investigation.
...
\label{Characterization Methods of Biochar}
...
%In physical adsorption, the intermolecular interactions (van der Waals forces) between the adsorbent and the adsorbate are relatively weak, which allows for the formation of multiple molecular layers as well as complete reversible desorption \cite{UniBayreuth2008BET}. 
...
%CHNS elemental analysis quantifies carbon, hydrogen, nitrogen, and sulphur by flash combustion of a weighed sample (~1800°C) in a controlled furnace, converting elements into stable gases (CO₂, H₂O, N₂, SO₂) that are chromatographically separated and detected, most commonly via thermal conductivity detection (Bird et al. 2017). Oxygen requires a separate pyrolysis-based configuration, converting sample oxygen to CO; high-temperature conversion (TC/EA) is considered more reliable than conventional EA for both O and H determination. Dry combustion has been validated as comparable to or better than wet-chemical alternatives (e.g., Kjeldahl for N) across various sample types.

%Biochar presents specific analytical challenges not fully addressed by existing standards, and no dedicated international protocol yet exists:

%High carbon content (often >80 wt%) demands precise low-milligram weighing.
%Condensed aromatic carbon, especially in high-temperature biochars, can resist complete combustion, biasing carbon values low. Carbonate content (e.g., CaCO₃) requires a clear distinction between total carbon and total organic carbon, per IBI (2014) guidelines. Low nitrogen content complicates accurate peak quantification against a much larger co-eluting carbon peak. Hygroscopicity necessitates careful drying and desiccated storage.
...
%Applying biochar to soil improves nutrient-holding capacity and water retention, helping to raise crop yield and overall soil fertility (Yadav et al., 2023). This works because biochar carries a negative surface charge and has a very high surface area, which lets it attract and hold onto positively charged nutrient ions (such as calcium, potassium, and ammonium) that would otherwise wash out of the soil, while its porous structure physically traps and slowly releases water to plant roots.

%Soil microbial and root health Biochar influences the habitat and activity of mycorrhizal fungi and other soil organisms, which directly stimulates soil quality and soil health (Yadav et al., 2023). This happens because biochar's porous surface offers a physical shelter where beneficial fungi and microbes can establish themselves more easily than in bare soil, and its buffering of soil pH and moisture creates more favorable conditions for these organisms to thrive and support plant roots.

%Carbon sequestration and greenhouse gas mitigation Biochar is considered important for carbon sequestration because of its potential to recycle agricultural waste, retain nutrients in soil, and lower greenhouse gas emissions, making it valuable for mitigating climate change (Yadav et al., 2023). This is possible because the pyrolysis process converts unstable plant carbon into a much more chemically stable, condensed form that soil microbes cannot easily break down and release as CO2 — so instead of decomposing within a few years like ordinary plant matter, the carbon in biochar can remain locked in the soil for a much longer period. The review also notes that biochar can slow the rate of methane oxidation and reduce the release of nitrous oxide in treated soils, likely tied to how it changes soil aeration and moisture conditions that control the activity of gas-producing soil microbes.

%Contaminant binding in soil 
%Once applied to soil, biochar binds and deactivates certain agrochemicals, such as herbicides, reducing their mobility and persistence in the environment (Yadav et al., 2023). This occurs because contaminant molecules become physically adsorbed onto biochar's large internal surface area and can also chemically bind to its surface functional groups, effectively locking them away from plant roots and groundwater — though the review also cautions that once bound this way, the biochar (and the contaminants held within it) cannot easily be removed from the soil.
