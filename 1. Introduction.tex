...
The general objective of this work is to explore the potential of different digestates from slaughterhouses for biochar production, including their potential modification through activation and sulfur loading. This work investigates the effect of pyrolysis temperature on biochar production, the effect of steam as an activating agent on biochar activation, and the feasibility of sulfur enrichment on the resulting biochars. This work also aims to characterize the properties of the resulting biochars. In addition, another objective of this work is to draw comparisons with the authors’ preceding project work on the production and characterization of biochar via pyrolysis and CO$_2$ activation and to discuss the findings.
...
\begin{itemize}
    \item to produce biochar from two different slaughterhouse digestates using pyrolysis at temperatures of 400, 500, and 600~$^\circ$C, and further determine the yield obtained at each temperature. 
    \item to carry out the activation of biochar with steam while maintaining a mass loss limit of 10\%, and to quantify the effect of the activation based on the associated mass loss.
    \item to carry out the sulfur-loading process on the activated biochars with hydrogen sulfide.
    ...
    \item to compare the results from the current work, and to set the findings against the CO$_2$-activation baseline of the authors’ preceding project work and discuss the findings.
\end{itemize}
...
The thesis is structured into several chapters, each of which covers specific aspects of the research that together outline the overall framework of this work as follows:
...
\textbf{chapter~4} presents the results of the work. The results are interpreted to highlight the key findings related to the overall objectives of this work. The key findings will be concluded at the end.
