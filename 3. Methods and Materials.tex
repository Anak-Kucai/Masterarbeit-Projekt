...
The higher heating value (HHV) of the raw digestate and of the biochar samples were determined using an isoperibolic bomb calorimeter (IKA C 200, IKA-Werke GmbH \& Co. KG) following the principle described in \S~\ref{subsubsec:HHV}. The instrument was calibrated at the beginning of each measurement campaign using certified benzoic acid pellets, which served as a reference material for determining the effective heat capacity $\varepsilon$ of the calorimeter system.
