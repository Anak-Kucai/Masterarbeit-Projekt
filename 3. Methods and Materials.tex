...
Firstly, the activated biochar samples were placed inside glass tubes that were open at both ends and plugged at both ends with cotton wool to keep the samples in place while allowing the gaseous flow of hydrogen sulfide to pass through the it without causing blockage. Each tube was connected with a Y-connector, which was linked to an air source and a reaction flask. 

\vspace{0.3em}

In the reaction flask, pulverized iron sulfide was placed and reacted gradually with droplets of hydrochloric acid from the funnel until the formation and release of hydrogen sulfide gas occurred, which can be characterized by the presence of continuous bubbling in the solution. The generated gaseous hydrogen sulfide was then directed to a Y-connector, where the $H_2S$ stream was introduced to the air stream, resulting in the partial oxidation of $H_2S$ to elemental sulfur and water. The resulting gaseous mixture then flowed through the activated biochar samples via each glass tube. The whole process lasted for approximately 30 minutes, allowing as much sulfur as possible to be absorbed on the surface of the biochar. Once the entire process was complete, the experimental setup was left undisturbed until the next day. The samples are then dried and weighed.
...
The analytical methods described in this section were applied to the raw digestate as well as to the biochar samples obtained after pyrolysis, $H_2O$ activation, and sulphurization, in order to evaluate the effect of each processing step on the resulting material properties
%Ini perlu KOREKSI
