...
The elemental analysis was also outsourced to EVUR. The mass fractions of carbon (C), hydrogen (H), nitrogen (N), and sulfur (S) in the untreated biochar, as well as in the sulfur-loaded and activated biochar samples were determined by combustion-based elemental analysis. The analysis consisted of four individual measurements, which were then calculated and presented as an arithmetic mean. These individual measurements were not released by the laboratory of TU Berlin, so that means no scatter can be shown.
