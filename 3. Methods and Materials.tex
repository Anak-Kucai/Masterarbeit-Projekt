...
The sulfur loading was carried out in the same chemistry laboratory where the H$_2$O activation took place. The sulfur loading process is carried out exclusively for activated biochar produced from French digestates. The process was conducted in the same chemistry laboratory room using simple laboratory-scale setup that resembles the principle process of biogas desulfurization. The setup consists of magnetic stirrer, reaction flask equipped with dropping funnel, glass tubes and connector tube (Figure \ref{fig:Schwsetup}), all of which are placed in an enclosed chamber equipped with a suction function.
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.78\linewidth]{Abbildungen/Kalorimeter.JPG}
...
The elemental analysis was also outsourced to EVUR. The mass fractions of carbon (C), hydrogen (H), nitrogen (N), and sulfur (S) in the untreated biochar as well as sulfur-loaded and activated biochar samples were determined by combustion-based elemental analysis. The analysis consisted of four individual measurements, which were then calculated and presented as an arithmetic mean.
