...
%  Included from the main file with \input{Symbolverzeichnis}
%  (after \listoftables, before \pagenumbering{arabic})
%
%  Styling follows plotstyle.tex: booktabs rules only, \thd{} headings,
%  L{} ragged-right paragraph columns. Do not add \hline or vertical
%  rules here.
%=====================================================================
...
%---------------------------------------------------------------------
{\small
\begin{longtable}{L{3cm}L{9.2cm}L{2.5cm}}
\toprule
\thd{Symbol} & \thd{Meaning} & \thd{Unit}\\
\midrule
\endfirsthead
\toprule
\thd{Symbol} & \thd{Meaning} & \thd{Unit}\\
