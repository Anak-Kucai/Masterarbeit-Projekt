...
\begin{table}[ht]
\centering
\caption{Elemental composition on an ash-free basis. Values for the
sulfur-loaded activated chars are pending the supplementary bomb-calorimetry
campaign noted in Table~\ref{tab:chns-full}.}
